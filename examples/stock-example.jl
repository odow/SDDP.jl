#==
This example comes from https://github.com/JuliaOpt/StochDynamicProgramming.jl/b
lob/release-0.4/examples/stock-example.jl
...
m = SDDPModel(
    ...
    @scenario(sp, noise = linspace(0, 0.3, 10), state == state0 + control - noise)
...
@test isapprox(mean(r[:objective] for r in results), 1.471, atol=0.001)
