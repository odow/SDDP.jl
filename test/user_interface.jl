...
function test_belief_updater()
    ...
    belief′ = copy(belief)
    @test belief_updater(model[2], belief′, belief, 2, :A) ==
          Dict(1 => 0.0, 2 => 1.0)
    @test belief′ == Dict(1 => 0.0, 2 => 1.0)
    belief = Dict(1 => 0.0, 2 => 1.0)
    @test belief_updater(model[1], belief′, belief, 1, :B) ==
          Dict(1 => 1.0, 2 => 0.0)
    ...
    belief = Dict(1 => 1.0, 2 => 0.0)
    @test belief_updater(model[1], belief′, belief, 1, :A) ==
          Dict(1 => 0.0, 2 => 1.0)
    belief = Dict(1 => 0.0, 2 => 1.0)
    @test belief_updater(model[1], belief′, belief, 1, :B) ==
          Dict(1 => 1.0, 2 => 0.0)
    ...
    @test is_approx(
        belief_updater(model[1], belief′, belief, 1, :A),
        Dict(1 => 6 / 41, 2 => 35 / 41),
    )
    return
end
